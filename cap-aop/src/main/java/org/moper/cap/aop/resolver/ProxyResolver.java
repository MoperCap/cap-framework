...
import org.moper.cap.aop.proxy.CglibProxyFactory;
...
public class ProxyResolver {
    ...
    public Object resolve(Object target, List<Advisor> advisors) {
        ...
        } else if(CGLIB_PROXY_FACTORY.canProxy(targetClass)) {
            return CGLIB_PROXY_FACTORY.createProxy(targetClass, target, advisors);
