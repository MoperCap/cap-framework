 ...
 * 控制器方法调用器。
 *
 * <p>使用 {@link ParameterHandlerRegistry} 解析所有方法参数，
...
public class HandlerInvoker {
    ...
    public HandlerInvoker(ParameterHandlerRegistry parameterHandlerRegistry) {
    ...
    private Object[] resolveArgs(List<ParameterMetadata> parameters,
        ...
        for (ParameterMetadata metadata : parameters) {
            args[metadata.index()] = parameterHandlerRegistry.resolve(
